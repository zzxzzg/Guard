...
public class AnimationExpandableListView extends ExpandableListView {
	...
	public AnimationExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//			}
	...
	public static abstract class AnimatedExpandableListAdapter extends
		...
		private AnimationExpandableListView parent;
		private static final int STATE_IDLE = 0;
		private static final int STATE_EXPANDING = 1;
		private static final int STATE_COLLAPSING = 2;

		private void setParent(AnimationExpandableListView parent) {
			this.parent = parent;
		}
