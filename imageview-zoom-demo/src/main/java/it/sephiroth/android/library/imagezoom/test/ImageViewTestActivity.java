...
//
//        mImage.setOverlayBitmap(BitmapFactory.decodeResource(getResources(),R.drawable.contour_chin));
//        mImage.mTestDrawable=getResources().getDrawable(R.drawable.contour_chin);
//        mImage.addOverlayPointF(new PointF(100,100));
	}
