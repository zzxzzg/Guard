...
//        return new String[]{MainFacade.COMMAND_LOGIN_SUCCESS,MainFacade.COMMAND_REGISTER_SUCCESS,MainFacade.COMMAND_LOGIN_FAIL};
//    }
//
//    @Override
...
//            Toast.makeText((Activity)getViewComponent(),"login sucess",Toast.LENGTH_SHORT).show();
//        }
//    }
//}
