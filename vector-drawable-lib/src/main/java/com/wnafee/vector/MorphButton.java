...
//            d.setLayoutDirection(getLayoutDirection());
    ...
    /**
     * Same as {@link com.wnafee.vector.MorphButton#setState(com.wnafee.vector.MorphButton.MorphState, boolean)} with no animation
     *
     ...
     * Choose button state
     *
     * @param state   a {@link com.wnafee.vector.MorphButton.MorphState} to set button to
