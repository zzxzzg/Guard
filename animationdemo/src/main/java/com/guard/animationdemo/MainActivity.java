...
public class MainActivity extends Activity {
    ...
    "CardFlipActivity","ZoomActivity","RippleL","RipplePreL","vector_L","XMEETING_LoginButton"};
    ...
    RippleLActivity.class,RipplePreLActivity.class, VectorLActivity.class,LoginButtonActivity.class};
