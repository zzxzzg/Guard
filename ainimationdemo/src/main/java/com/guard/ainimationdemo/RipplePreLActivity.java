...
public class RipplePreLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewUtils.setRippleBackground(getResources(), getTheme(), button1, com.guard.ainimationdemo.R.drawable.ripple1);

        ViewUtils.setRippleBackground(getResources(), getTheme(), button2, com.guard.ainimationdemo.R.drawable.ripple1);
