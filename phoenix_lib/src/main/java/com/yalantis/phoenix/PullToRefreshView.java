...
public class PullToRefreshView extends ViewGroup {
    ...
    private BaseFrameView mAnimationDrawable;
    ...
    public void setRefreshFrame(BaseFrameView drawable){
        mRefreshDrawable=drawable;
        mAnimationDrawable=drawable;
        mRefreshView.setScaleType(ImageView.ScaleType.CENTER);
        mRefreshView.setImageDrawable(drawable);
    }
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mRefreshDrawable = new SunRefreshView(getContext(), this);
                mBaseRefreshView = (BaseRefreshView) mRefreshDrawable;
                break;
            case STYLE_FRAME:
                break;
            default:
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(mRefreshDrawable != null && mRefreshDrawable instanceof BaseRefreshView){
            if(!mBaseRefreshView.isInitSuccess()){
                mBaseRefreshView.reInit();
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if(mRefreshDrawable instanceof BaseRefreshView) {
                    mBaseRefreshView.setPercent(mCurrentDragPercent, true);
                }else if(mRefreshDrawable instanceof BaseFrameView){
                    mAnimationDrawable.setPercent(mCurrentDragPercent);
                }
