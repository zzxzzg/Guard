...
//                a.recycle();
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator anim,
        ...
        if (valueType == VALUE_TYPE_PATH) {
            ...
            float fromString = arrayAnimator.getFloat(R.styleable.Animator_android_valueFrom, 0);
            float toString = arrayAnimator.getFloat(R.styleable.Animator_android_valueTo,0);
            anim.setFloatValues(fromString,toString);
        }else if(valueType==VALUE_TYPE_INT){
            int fromString = arrayAnimator.getInt(R.styleable.Animator_android_valueFrom, 0);
            int toString = arrayAnimator.getInt(R.styleable.Animator_android_valueTo,0);
            anim.setIntValues(fromString,toString);
        }else{
