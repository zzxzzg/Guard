...
import com.guard.animationlib.circul.RevealAnimator;
...
public class CircleRevealHelper implements AbsListView.OnScrollListener {
...
//        setTransitionEffect(transitionEffect);
    ...
    private void doJazzinessImpl(View item, int position, int scrollDirection) {
        ...
        if(!(item instanceof RevealAnimator)){
            return;
        }
        View myView=((ViewGroup)item).getChildAt(0);
